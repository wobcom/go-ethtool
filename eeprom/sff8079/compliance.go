...
// NewCompliance parses [8]byte into a Compliance instance
...
// IsSFPCableImplementation returns true if ComplianceFlagActiveCable or ComplianceFlagPassiveCable is set indicating a non optical implementation
